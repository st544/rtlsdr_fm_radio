...
class GNU_FM_Proto(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "GNU_FM_Proto")
        ...
        self.connect((self.analog_wfm_rcv_1, 0), (self.qtgui_freq_sink_x_0_1, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 100e3, 50e3, window.WIN_KAISER, 6.76))
        self.qtgui_freq_sink_x_0.set_frequency_range(93.3e6, self.samp_rate)
        self.qtgui_freq_sink_x_0_0.set_frequency_range(93.3e6, self.samp_rate)
        self.rtlsdr_source_0.set_sample_rate(self.samp_rate)




def main(top_block_cls=GNU_FM_Proto, options=None):
